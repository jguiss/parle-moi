  ...
  return (
    <div className="min-h-screen bg-bg-deep flex flex-col items-center justify-center px-6">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-text-secondary font-body">{t("register.subtitle")}</p>
      </div>
      ...
      <p className="mt-6 text-sm text-text-dim font-body">
        ...
        <Link href="/auth/login" className="text-accent hover:underline">{t("register.loginLink")}</Link>
      </p>
